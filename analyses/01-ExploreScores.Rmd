...
<br/>
<br/>
```{r figureA, eval=TRUE, echo=FALSE, cache=TRUE, warning=FALSE, message=FALSE}
...
<br/>
```{r figureB, eval=TRUE, echo=FALSE, cache=TRUE, warning=FALSE, message=FALSE}
### Load required package(s)
...
q <- ggplot(df3, aes(Mean, Unanimity)) + 
  ...
  labs(x = "Mean Score", y = "
       Unanimity",
       title ="Figure C: Mean score per species against unanimity (1- variance)",
